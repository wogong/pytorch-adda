...
from core import eval, train_src, train_tgt
from models.office import Discriminator, Encoder, Classifier
...
if __name__ == '__main__':
    ...
    if not (src_encoder.restored and src_classifier.restored and params.src_model_trained):
        src_encoder, src_classifier = train_src(src_encoder, src_classifier, src_data_loader, tgt_data_loader, params)
